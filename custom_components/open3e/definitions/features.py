...
class Features:
    class Temperature:
        ...
        FlowCircuit2Cooling = Feature(id=2405, refresh_interval=30)
        FlowCircuit3Cooling = Feature(id=2405, refresh_interval=30)
        FlowCircuit4Cooling = Feature(id=2405, refresh_interval=30)
